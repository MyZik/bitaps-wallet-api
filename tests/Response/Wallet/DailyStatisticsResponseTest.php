...
namespace Bitaps\WalletAPI\Tests\Response\Wallet;

use Bitaps\WalletAPI\Response\Wallet\Model\DailyStatistics;
use Bitaps\WalletAPI\WalletAPI;
use PHPUnit\Framework\TestCase;

class DailyStatisticsResponseTest extends TestCase
{
